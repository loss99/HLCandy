...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HLChat/HLChat.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HLDB/HLDB.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HLKit/HLKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HLLogin/HLLogin.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HLMatch/HLMatch.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HLMe/HLMe.framework"
